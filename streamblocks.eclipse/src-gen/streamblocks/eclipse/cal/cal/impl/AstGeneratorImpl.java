 ...
 * </p>
 * <ul>
 *   <li>{@link streamblocks.eclipse.cal.cal.impl.AstGeneratorImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link streamblocks.eclipse.cal.cal.impl.AstGeneratorImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link streamblocks.eclipse.cal.cal.impl.AstGeneratorImpl#getFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AstGeneratorImpl extends MinimalEObjectImpl.Container implements AstGenerator
{
   ...
   * @ordered
   */
  protected EList<AstExpression> filter;
   ...
   */
  @Override
  public EList<AstExpression> getFilter()
  {
    if (filter == null)
    {
      filter = new EObjectContainmentEList<AstExpression>(AstExpression.class, this, CalPackage.AST_GENERATOR__FILTER);
    }
    return filter;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case CalPackage.AST_GENERATOR__FILTER:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case CalPackage.AST_GENERATOR__FILTER:
        getFilter().clear();
        getFilter().addAll((Collection<? extends AstExpression>)newValue);
        return;
    }

 ...
 * </p>
 * <ul>
 *   <li>{@link streamblocks.eclipse.cal.cal.impl.AstStructureImpl#getConnections <em>Connections</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AstStructureImpl extends MinimalEObjectImpl.Container implements AstStructure
{
   ...
   * @ordered
   */
  protected EList<AstStructureStatement> connections;
   ...
   */
  @Override
  public EList<AstStructureStatement> getConnections()
  {
    if (connections == null)
    {
      connections = new EObjectContainmentEList<AstStructureStatement>(AstStructureStatement.class, this, CalPackage.AST_STRUCTURE__CONNECTIONS);
    }
    return connections;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case CalPackage.AST_STRUCTURE__CONNECTIONS:
        ...
        getConnections().addAll((Collection<? extends AstStructureStatement>)newValue);
        return;
    }
